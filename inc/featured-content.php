...
*/
function mercia_featured_content() {
 ...
 * @return int
 */
function mercia_featured_excerpt_length( $length ) {
	return 15;
}


if ( ! function_exists( 'mercia_featured_post_image' ) ) :
	/**
	 ...
	 */
	function mercia_featured_post_image( $size = 'post-thumbnail', $attr = array() ) {
...
if ( ! function_exists( 'mercia_featured_entry_meta' ) ) :
	/**
	 * Displays the date and author on featured posts
	 */
	function mercia_featured_entry_meta() {
