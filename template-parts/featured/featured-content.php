...
$featured_category = mercia_get_option( 'featured_category' );

// Get cached post ids.
$post_ids = mercia_get_magazine_post_ids( 'featured-content', $featured_category, 5 );
...
if ( $featured_query->have_posts() ) :
	...
	add_filter( 'excerpt_length', 'mercia_featured_excerpt_length' );
	?>
	...
	remove_filter( 'excerpt_length', 'mercia_featured_excerpt_length' );
